...
Point<double> polygon_center(const Point<T>* pts, size_t n) 
{
    ...
    return Point<double>(cx * factor, cy * factor);
}


template double polygon_area<int>(const Point<int>*, size_t);
template double polygon_area<double>(const Point<double>*, size_t);
template Point<double> polygon_center<int>(const Point<int>*, size_t);
template Point<double> polygon_center<double>(const Point<double>*, size_t);
